...
import imageLogo from "../assets/image/masudranabd_logo.png"
const Footer = () => {
  return (
    <>
      ...
      <footer className="footer sm:footer-horizontal bg-white text-base-content p-10 border-t border-gray-200">
        <aside>
          ...
          <p className="text-gray-600 max-w-xs">
            ...
            Specialized in logo design, branding, and digital graphics since
            2020.
          </p>
          <div className="flex gap-3 mt-4">
            <a
              href="https://x.com/MasudRana0161"
              className="text-gray-500 hover:text-[#940000] transition-colors"
            >
              <svg
        ...
        <nav>
          ...
          <a className="link link-hover text-gray-600 hover:text-[#940000] transition-colors">
            Logo Design
          </a>
          <a className="link link-hover text-gray-600 hover:text-[#940000] transition-colors">
            Brand Identity
        ...
        <nav>
          ...
          <Link
            to="/work"
            className="link link-hover text-gray-600 hover:text-[#940000] transition-colors"
          >
            Portfolio
          </Link>
          <Link
          ...
          <Link
            to="https://www.fiverr.com/s/2KlPZLL"
            className="link link-hover text-gray-600 hover:text-[#940000] transition-colors"
          >
            Fiverr
          </Link>
        ...
        <nav>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span>masudrana.free24@gmail.com</span>
            </div>
            <div className="flex items-center gap-2 text-gray-600">
              <svg
                className="w-4 h-4"
      ...
      <footer className="footer sm:footer-horizontal footer-center bg-gray-50 text-base-content p-4 border-t border-gray-200">
        ...
        <nav className="hidden sm:block">
          <div className="flex gap-6 text-gray-600 text-sm">
            <a href="#" className="hover:text-[#940000] transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="hover:text-[#940000] transition-colors">
              Terms of Service
